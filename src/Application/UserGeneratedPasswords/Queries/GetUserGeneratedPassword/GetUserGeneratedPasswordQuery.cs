...
[Authorize]
public sealed class GetUserGeneratedPasswordQuery
    : IRequest<UserGeneratedPasswordItem?>
{
...
internal sealed class GetUserGeneratedPasswordQueryHandler
    : IRequestHandler<GetUserGeneratedPasswordQuery, UserGeneratedPasswordItem?>
{
    private readonly IApplicationDbContext _dbContext;
    private readonly ICurrentUserService _currentUserService;
    private readonly IDateTime _dateTime;

    public GetUserGeneratedPasswordQueryHandler(
    ...
    public async Task<UserGeneratedPasswordItem?> Handle(
        GetUserGeneratedPasswordQuery request,
        CancellationToken cancellationToken)
    {
        ...
        IQueryable<UserGeneratedPassword> query = _dbContext
            .UserGeneratedPasswords
            .Where(p => p.Id == request.GeneratedPasswordId && p.UserId == currentUserId);
